...
1. **Clone the repository:**
   ...
   **Quick Setup (One-liner):** Alternatively, use this PowerShell one-liner to download the repo as a ZIP (no git required) and set up the webhook. The repo will be extracted to your system's TEMP directory (e.g., C:\Users\YourUser\AppData\Local\Temp\SysadminScriptsandJunk-main):
   ```powershell
