...
This repository contains PowerShell scripts designed for system administrators to automate tasks like monitoring user directories, folder contents, browser history extraction, and website blocking. All scripts send results to a Discord webhook for easy notification and logging. It's most helpful for IT professionals and sysadmins who need quick, portable tools for system investigations, data collection, and basic network management on Windows machines.
